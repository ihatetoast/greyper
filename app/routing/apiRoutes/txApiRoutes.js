...
//apply new fcns here.
import { initCap, deleteExtraText, slugify } from '../../../helpers/helpers';
...
module.exports = function(app) {
  ...
  app.get('/api/galt', function(req, res) {
    request(`http://galtx.org/hounds/available.shtml`, function(
      err,
      response,
      html
    ) {
  ...
  app.get('/api/centex', function(req, res) {
    ...
    request(`https://galtx-centex.org/greyhounds/`, function(
      err,
      response,
      html
    ) {
